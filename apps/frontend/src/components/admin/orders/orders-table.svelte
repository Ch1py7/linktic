...
{#if orders.length !== 0}
  <Card>
    <h2 class="text-2xl font-bold mb-5">Orders</h2>
    <table class="w-full">
      <thead>
        <tr class="border-b border-b-1 border-solid border-gray">
          <th class="ps-2 pb-3 w-20">
            <p class="font-semibold text-center text-gray-600">Order id</p>
          </th>
          <th class="ps-2 pb-3 w-56">
            <p class="font-semibold text-center text-gray-600">Products name</p>
          </th>
          <th class="ps-2 pb-3 w-24">
            <p class="font-semibold text-center text-gray-600">Products quantity</p>
          </th>
          <th class="ps-2 pb-3">
